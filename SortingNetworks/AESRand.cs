...
namespace SortingNetworks
{
    ...
    /// </summary>
    /// <remarks>
    /// This class exists because using <c>System.Random</c> during benchmarking unveals a bimodal timing distribution,
    /// which makes a rather bad baseline.  Code adapted from https://github.com/dragontamer/AESRand/blob/master/AESRand/AESRand/AESRand.cpp
    /// </remarks>
    struct AESRand {
        ...
        public void Initialize(uint state = 0) {
            this.state = Vector128.Create(state).AsUInt64();
        }
